...
class KitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kit" do
    assert_difference("Kit.count") do
      post kits_url, params: { kit: { description: @kit.description, name: @kit.name, user_id: @kit.user_id } }
    end
  ...
  test "should update kit" do
    patch kit_url(@kit), params: { kit: { description: @kit.description, name: @kit.name, user_id: @kit.user_id } }
